...
// both to the feet-based shape computeChairTransforms expects.
function chairInputForTableType(tableType, footprint) {
...
function chairInputForPinnedObstacle(obstacle) {
